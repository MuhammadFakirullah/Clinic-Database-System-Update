...
<!-- Add Patient -->
<div class="modal fade" id="pharmacyAddModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form id="savePharmacy">
            <div class="modal-body">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="pharmacy_username" class="form-control" />
                </div>
                <div class="mb-3">
                    <label for="">Password</label>
                    <input type="text" name="pharmacy_password" class="form-control" />
                </div>
                <div class="mb-3">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>Pharmacy Account
                        <button type="button" class="btn btn-primary float-end " data-bs-toggle="modal" data-bs-target="#pharmacyAddModal">
                            <i class="fa fa-plus-circle"></i> Add Pharmacy
                        </button>
                    </h4>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            <?php
                                ...
                                if (isset($_GET['search'])) {
                                    $search = $_GET['search'];
                                    $query = "SELECT * FROM pharmacy WHERE pharmacy_username LIKE '%$search%' OR pharmacy_password LIKE '%$search%' LIMIT $starting_record, $records_per_page";
                                } else {
                                    $query = "SELECT * FROM pharmacy LIMIT $starting_record, $records_per_page";
                                }
                                ...
                                if (isset($_GET['search'])) {
                                    $search = $_GET['search'];
                                    $count_query = "SELECT COUNT(*) as total FROM pharmacy WHERE pharmacy_username LIKE '%$search%' OR pharmacy_password LIKE '%$search%'";
                                } else {
                                    $count_query = "SELECT COUNT(*) as total FROM pharmacy";
                                }
...
<script>
        ...
        $(document).on('click', '.editPharmacyBtn', function () {
            ...
            $.ajax({
                type: "GET",
                url: "code_adminpharmacy.php?pharmacy_id=" + pharmacy_id,
                success: function (response) {
