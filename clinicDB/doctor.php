...
// If the user is logged in, continue displaying the doctor.php content
?>
                            ...
                            <?php
                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    foreach ($query_run as $patient) {
                                        $formattedtimestamp = date("d-m-Y H:i", strtotime($patient['appointmentDateTime']));
                                        ?>
                                        <tr>
                                            <td><?= $patient['id'] ?></td>
                                            <td><?= $patient['name'] ?></td>
                                            ...
                                            <td>
                                                <?php if ($patient['appointment_status'] === 'Yes') { ?>
                                                    <span class="badge bg-success">Yes</span>
                                                <?php } elseif ($patient['appointment_status'] === 'No') { ?>
