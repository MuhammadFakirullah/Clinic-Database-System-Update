            ...
            <ul class="navbar-nav ml-auto custom-nav">
                <li class="nav-item">
                    <a class="nav-link active text-light" aria-current="page" href="">
                        ...
                        ?>
                        <img src="<?php echo $admin_image; ?>" alt="Admin image" width="25" height="25">
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active text-light" aria-current="page" href="">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link active text-light" aria-current="page" href="logout_admin.php"><i class="fas fa-door-open"></i> Log out
                </a>
                </li>
            </ul>
          </div>
